...
plot(hpcDataSmall$DateTime,hpcDataSmall$Sub_metering_1,  type = "l", xlab = NULL, ylab = "Energy sub metering")
...
legend("topright", c("Sub-metering_1","Sub-metering_2","Sub-metering_3"), col = c("Black","Red","Blue"), lwd = 1, lty = 1, seg.len = 2)
dev.off()
